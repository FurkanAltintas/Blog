...
namespace Blog.Mvc.Areas.Admin.Controllers
{
    ...
    public class ArticleController : BaseController
    {
        ...
        public ArticleController(IArticleService articleService, ICategoryService categoryService, UserManager<User> userManager, IImageHelper imageHelper, IMapper mapper, IToastNotification toastNotification) : base(userManager, mapper, imageHelper)
        {
