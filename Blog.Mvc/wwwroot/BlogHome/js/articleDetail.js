$(document).ready(function () {
    $(function () {
        $(document).on('click', '#btnSave', function (event) {
            event.preventDefault(); // Butonun kendi default işlemini engellemiş oluyoruz
            ...
            <div class="media mb-4">
                <img class="d-flex mr-3 rounded-circle" src="https://randomuser.me/api/portraits/women/17.jpg" alt="${commentAddAjaxModel.CommentDto.Comment.CreatedByName}">
                <div class="media-body">
                    ...
                    Bir örneği sizler için karşınıza gelecek. Fakat; yorumunuz onaylandıktan sonra görünür olacaktır.`);
                    $('#btnSave').prop('disabled', true);
                    setTimeout(function () {
                        $('#btnSave').prop('disabled', false);
                    }, 15000); // Bizlerden bir fonksiyon ve süre alır. Süre bittiğinde fonksiyon çalışır
                    // 15 saniye sonra butonumuz kullanılabilir olacaktır.
                } else {
                    let summaryText = '';
